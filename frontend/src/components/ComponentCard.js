...
const PARAM_NAMES = {
  ...
  // Давления
  'pressure_in': { name: 'Давление на входе', unit: 'МПа' },
  'pressure_out': { name: 'Давление на выходе', unit: 'МПа' },
  'AI_P_Oil_Nas_n': { name: 'Давление в маслосистеме насоса', unit: 'МПа' },
  ...
  // Расход
  'AI_Qmom_n': { name: 'Мгновенный расход жидкости', unit: 'м³/с' },
